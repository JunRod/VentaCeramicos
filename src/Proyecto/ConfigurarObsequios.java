...
public class ConfigurarObsequios extends JDialog implements ActionListener {
    ...
    public ConfigurarObsequios() {
...

        {
            ...
            lblTipodeobsequio.setFont(new Font("Times New Roman", Font.PLAIN, 12));
        ...
        }
        {
            ...
            lbl1a5unidades.setFont(new Font("Times New Roman", Font.PLAIN, 12));
            lbl1a5unidades.setBounds(10, 45, 130, 31);
            getContentPane().add(lbl1a5unidades);
        }
        {
            JLabel lbl6a10unidades = new JLabel("6 a 10 unidades");
            lbl6a10unidades.setFont(new Font("Times New Roman", Font.PLAIN, 12));
        ...
        }
        {
            ...
            lbl11amasunidades.setFont(new Font("Times New Roman", Font.PLAIN, 12));
            lbl11amasunidades.setBounds(10, 102, 130, 31);
            getContentPane().add(lbl11amasunidades);
        }
        {
            txtTipodeobsequio = new JTextField();
            txtTipodeobsequio.setFont(new Font("Times New Roman", Font.PLAIN, 12));
        ...
        }
        {
            ...
            txt11amas.setFont(new Font("Times New Roman", Font.PLAIN, 12));
...

        {
            ...
            btnCancelar.setBounds(341, 48, 85, 24);
        ...
        }
        {
            ...
            btnAceptar.setBounds(341, 20, 85, 24);
