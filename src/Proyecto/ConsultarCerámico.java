...
public class ConsultarCerámico extends JDialog implements ActionListener {
    ...
    public ConsultarCerámico() {
        ...
        cboModelo.setFont(new Font("Times New Roman", Font.PLAIN, 12));
        ...
        txtLargo.setFont(new Font("Times New Roman", Font.PLAIN, 12));
        ...
        txtEspesor.setFont(new Font("Times New Roman", Font.PLAIN, 12));
        ...
        txtContenido.setFont(new Font("Times New Roman", Font.PLAIN, 12));
