...
public class GenerarReportes extends JDialog implements ActionListener {
	...
	public GenerarReportes() {
		...
		getContentPane().setLayout(null);
		{
			...
			lblTipoDeReporte.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		...
		cboTipoDeReporte_1.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		...
		btnCerrar_1.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		...
		txtS = new JTextArea();
		txtS.setFont(new Font("Times New Roman", Font.PLAIN, 14));
