...
public class ModificarCerámico extends JDialog implements ActionListener {
    ...
    public ModificarCerámico() {
        ...
        cboModelo.setFont(new Font("Times New Roman", Font.PLAIN, 14));
        ...
        txtAncho.setFont(new Font("Times New Roman", Font.PLAIN, 14));
        txtAncho.setBounds(125, 58, 151, 20);
        getContentPane().add(txtAncho);
        txtAncho.setColumns(10);

        txtLargo = new JTextField();
        txtLargo.setFont(new Font("Times New Roman", Font.PLAIN, 14));
        txtLargo.setBounds(125, 83, 151, 20);
        getContentPane().add(txtLargo);
        txtLargo.setColumns(10);

        txtEspesor = new JTextField();
        txtEspesor.setFont(new Font("Times New Roman", Font.PLAIN, 14));
        txtEspesor.setBounds(125, 108, 151, 20);
        getContentPane().add(txtEspesor);
        txtEspesor.setColumns(10);

        txtContenido = new JTextField();
        txtContenido.setFont(new Font("Times New Roman", Font.PLAIN, 14));
        ...
        btnGrabar.setFont(new Font("Times New Roman", Font.PLAIN, 14));
